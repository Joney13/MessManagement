...
public class SelectMemberAdapter extends RecyclerView.Adapter<SelectMemberAdapter.MemberViewHolder> {

    private List<Member> memberList;
    private List<String> documentIds;

    public SelectMemberAdapter(List<Member> memberList, List<String> documentIds) {
        this.memberList = memberList;
        this.documentIds = documentIds;
    }

    // নতুন ডেটা দিয়ে অ্যাডাপ্টার আপডেট করার জন্য
